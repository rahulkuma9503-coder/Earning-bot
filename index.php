<?php
// Bot configuration - Use Environment Variable for the token
define('BOT_TOKEN', $_ENV['BOT_TOKEN'] ?? 'Place_Your_Token_Here');
define('BOT_USERNAME', $_ENV['BOT_USERNAME'] ?? 'Your_Bot_Username');
...
// Start bot only if run from command line
if (php_sapi_name() === 'cli') {
    ...
    // This part runs when accessed via web browser, to satisfy health checks
    echo "Bot is running.";
}
?>
